      ...
      <div id='smooth-wrapper'>
        <div id='smooth-content'>
          ...
          <div className='flex gap-8 justify-center mt-152 w-full bg-[#4B2814] p-32'>
            ...
            <div className='w-[90%] self-center flex flex-col'>
              <div>
                ...
                <p className='text-5xl leading-normal'>My name is <span className='text-red-400'>Jovany Valenzuela Gambino</span>, i am a United States Citizen / Mexico Citizen and a frontend developer passionate about web development and user interface design.
          ...
          <div className='flex flex-col mt-140'>
            ...
            <div className='flex flex-col lg:flex-row justify-center gap-20 w-[90%] self-center mb-100'>
              {
                projects.map(p => {
                  return (
                    <PersonalProject
